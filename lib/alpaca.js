...
class Alpaca {
  ...
  constructor(params = {}) {
    ...
    this.alpacaKey = params.alpaca_key;
    this.alpacaSecret = params.alpaca_secret;
    this.alp = new AlpacaAPI({
      keyId: this.alpacaKey,
      secretKey: this.alpacaSecret,
      paper: _.startsWith(this.alpacaKey, 'P')
    });
  ...
  async getAccountDetails() {
    ...
    return {
      ...
      live: !_.startsWith(this.alpacaKey, 'P'),
      margin_type: 'reg_t',
