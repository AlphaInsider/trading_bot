...
class Server {
  ...
  async updateSettings(params) {
    ...
    .update({
      ...
      ...((params.rebalance_on_start) ? {rebalance_on_start: params.rebalance_on_start} : {}),
  ...
  async searchStrategies(params) {
    ...
    //validate
    j.assert(params, j.object({
      search: j.string().optional(),
      positions: j.object().optional(),
      industries: j.object().optional(),
      type: j.object().optional(),
      risk: j.array().optional(),
  ...
  async getUserStrategies(params) {
    //init
    await this.ready;
    ...
    //get user strategies
    let userStrategies = await this.AlphaInsider.getUserStrategies({
